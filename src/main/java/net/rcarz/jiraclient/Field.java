...
public final class Field {
    ...
    public static <T extends Resource> T getResource(
        ...
        if (r instanceof JSONObject && !((JSONObject) r).isNullObject()) {
            ...
            else if (type == Assignee.class)
                result = (T) new Assignee(restclient, (JSONObject) r);
            ...
            switch (type) {
                ...
                case "version": {
                    ...
                    if (realValue instanceof ValueTuple) {
                        ...
                        itemMap.put(ValueType.ID_NUMBER.toString(), realValue.toString());
    ...
    public static Object toJson(String name, Object value, JSONObject editmeta)
        ...
        } else if (m.type.equals("user") || m.type.equals("resolution") || m.type.equals("securitylevel")) {
        ...
        } else if (m.type.equals("issuetype") || m.type.equals("priority") || m.type.equals("option")) {
            JSONObject json = new JSONObject();
